...
namespace esphome
{
    namespace panaac
    {
        ...
        void PanaACClimate::setup()
        {
            ...
            this->status_pref_ = this->make_entity_preference<std::array<ClimateState, 10>>();
                        ...
                        *ac_state = ClimateState
                        {
                            ...
                            swing_v_pos: PANAAC_SWINGV_AUTO,
                            swing_h_pos: PANAAC_SWINGH_AUTO,
                            last_swing_v_pos: PANAAC_SWINGV_MIDDLE,
                            last_swing_h_pos: PANAAC_SWINGH_MIDDLE,
                            nanoex: false,
                            econavi: false,
                            cool_with_dry: false,
                            clothes_dry: false
