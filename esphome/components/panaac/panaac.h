...
namespace esphome
{
    namespace panaac
    {
        ...
        protected:
            ...
            std::array<ClimateState, 10> *status_list_ = { ClimateState(),ClimateState(),ClimateState(),ClimateState(),ClimateState(),ClimateState(),ClimateState(),ClimateState(),ClimateState(),ClimateState() };
